...
for (i in angle) {
  oneplot.allellipse(sprintf("../../simul/fig_1abc/m/simuangle%s.parangle%s.par", i,i), S.factor=S.factor, M.factor=M.factor, Sell=TRUE, Mell=FALSE,
  ...
  oneplot.allellipse(sprintf("../../simul/fig_1abc/m/simuangle%s.parangle%s.par", i,i), S.factor=S.factor, M.factor=M.factor, Sell=FALSE, Mell=TRUE,
                   xlim=c(-0.2,0.2), ylim=c(-0.2,0.2), all.reps=FALSE, xlab="", ylab="",
                   yaxt = "n", xaxt = "n", legend=legend, asp=1, axes = FALSE,mgp = c(0, 0, 0))
  if(i==0){text("M multilinear", x=0, y=0.15)}
  oneplot.allellipse(sprintf("../../simul/fig_1abc/w/simuangle%s.parangle%s.par", i,i), S.factor=S.factor, M.factor=M.factor, Sell=FALSE, Mell=TRUE,
                   xlim=c(-0.2,0.2), ylim=c(-0.2,0.2), all.reps=FALSE, xlab="", ylab="",
                   yaxt = "n", xaxt = "n", legend=legend, asp=1, axes = FALSE,mgp = c(0, 0, 0))
